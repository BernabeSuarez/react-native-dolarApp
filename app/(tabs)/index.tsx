...
export default function Index() {
  return (
    <View className="flex-1 bg-slate-800 pt-8 px-4">
      <ScrollView className="flex-1 w-full h-full">
        <View className="flex-1 ipx-6 py-8">
          <Text className="text-3xl text-center font-bold text-[#22c55e] mb-4">
            Dolarcito
          </Text>
          <Text className="text-md font-light text-white">
            Explora el valor actual del Dólar 💵 y todas sus cotizaciones del
            día en Argentina 🇦🇷 desde un mismo lugar.
          </Text>
          <Text className="text-md font-light text-white">
